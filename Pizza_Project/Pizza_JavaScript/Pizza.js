function getReceipt() {
    //THis initilizes our string so it can get passed from function to function
...
function getTopping(runningTotal, text1) {
    ...
    //These variables wil be passed on to the next function
...
function getVegetable(runningTotal, text1) {
    ...
    if (vegetableCount > 2) {
        vegetableTotal = (vegetableCount - 2);
    } else {
        vegetableTotal = 0;
    }
    runningTotal = (runningTotal + vegetableTotal);
    console.log("total selected topping items: "+vegetableCount);
    console.log(vegetableCount+" topping - 1 free topping = "+"$"+vegetableTotal+".00");
    console.log("topping text1: "+text1);
    console.log("Purchase Total: "+"$"+runningTotal+".00");
